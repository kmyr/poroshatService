      ...
      <div class="sheet" id="sheet">
        ...
        <div class="body-part">
          ...
          <span class="bold">
            ...
            مصوبه شورای عالی کار در سال 1400 می باشد
          </span>
          <br />
          <span class="titr">ماده 5) مـدت قـرارداد</span>
          <br />
          مـدت قـرارداد از تـاريـخ 1400/{{ userInfo.startDate.month }}/{{
            userInfo.startDate.day
          }}
          لغـايـت 1400/{{ userInfo.finishDate.month }}/{{
            userInfo.finishDate.day
          }}
          مي بـاشـد
          <br />
