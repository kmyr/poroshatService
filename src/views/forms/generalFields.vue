<template>
  <div>
    <form id="workerActionsForm">
      ...
      <input
        name="required"
        v-model="prepareWorker.birthDate"
        type="text"
        class="form-control"
        style="margin-bottom: 15px"
      />
      ...
      <input
        name="required"
        v-model="prepareWorker.studyField"
        type="text"
        class="form-control"
        style="margin-bottom: 15px"
      />
      ...
      <input v-model="prepareWorker.tel" type="text" class="form-control" />
...
import { diploma, gender, department } from "../../datastore/globalData";
    ...
    inputValidation(command) {
      ...
      if (this.detectEmptyData() == true) {
        if (command == "newWorker") {
          this.postData("employees", this.prepareWorker, true);
